...
class OrderStatusUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'persage' => 'required|numeric|min:0|max:100|unique:order_status,persage,' . $id,
            'backgroud_color' => 'required|string|size:7', // Color hex codes are typically 7 characters long
            'id' => 'required|exists:order_status,id',
    ...
    public function messages()
    {
        return [
            ...
            'id.exists' => 'The selected ID does not exist in the Order status.',
