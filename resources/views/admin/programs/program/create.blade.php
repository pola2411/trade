                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{old('calender_ar')}}"
                                        name="calender_ar" required placeholder="please enter Calender AR "
                                        id="calender_ar">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{old('calender_en')}}"
                                        name="calender_en" required placeholder="please enter Calender AR "
                                        id="calender_en">
                                </div>
                            </div>
                            <!--end col-->
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{old('interest_ar')}}"
                                        name="interest_ar" required placeholder="please enter Interest AR "
                                        id="interest_ar">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{old('interest_en')}}"
                                        name="interest_en" required placeholder="please enter Interest AR "
                                        id="interest_en">
                                </div>
                            </div>
                            <!--end col-->
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type='number' required class="form-control" value="{{old('value')}}"
                                        name="value" placeholder="please enter program value" id="firstNameinput">
                                </div>
                            </div>
                            <!--end col-->
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="js-example-basic-single form-control" required name="program_type_id">
                                    ...
                                    <option value="{{ $type['id'] }}" {{ $type['id']==old('program_type_id')
                                        ? 'selected' : '' }}>
                                        {{
                                        $type['title'] }}</option>
                                    @endforeach
