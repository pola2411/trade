                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" required value="{{old('title_ar')}}"
                                                name="title_ar" placeholder="please enter Field AR" id="firstNameinput">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-md-12 my-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" required value="{{old('title_en')}}"
                                                name="title_en" placeholder="please enter Field EN" id="firstNameinput">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" required value="{{old('title_ar')}}"
                                                name="title_ar" placeholder="please enter Field AR" id="title_ar">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-md-12 my-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" required value="{{old('title_en')}}"
                                                name="title_en" placeholder="please enter Field EN" id="title_en">
                                        </div>
                                    </div>
            ...
            columns: [
...

                {
                    ...
                    render: function(data) {
                        ...
                        var deleteUrl = '{{ route('fields.delete', ':Fields') }}';
                        deleteUrl = deleteUrl.replace(':Fields', data.id);
